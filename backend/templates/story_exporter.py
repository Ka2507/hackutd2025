...
class StoryExporter:
    ...
    def to_csv(stories: List[Dict[str, Any]]) -> str:
        ...
        for story in stories:
            ...
            writer.writerow({
                ...
                'tags': tags_text,
                'epic': story.get('epic', ''),
                'author': story.get('author', 'ProdigyPM AI'),
    ...
    def to_markdown(stories: List[Dict[str, Any]], title: str = "User Stories") -> str:
        ...
        lines = [
            ...
            f"**Generated By:** ProdigyPM 9-Agent AI System  ",
            f"",
            "---",
            ""
        ]
        ...
        for idx, story in enumerate(stories, 1):
            ...
            if story.get('ai_enhanced'):
                ...
                lines.append("✨ *Generated by ProdigyPM 9-Agent System with:*")
    ...
    def to_json(stories: List[Dict[str, Any]], pretty: bool = True) -> str:
        ...
        data = {
            ...
            "generated_by": "ProdigyPM 9-Agent AI System",
            "format_version": "1.0",
