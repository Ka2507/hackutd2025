...
class ResearchAgent(BaseAgent):
    ...
    async def _user_research(self, query: str, sources: List[str]) -> Dict[str, Any]:
        ...
        prompt = f"""Synthesize user research and feedback about: {query}

Sources to analyze: {', '.join(sources)}

Please provide:
1. Key user insights and pain points
2. Common themes and patterns
3. User needs and desires
4. Feedback trends
5. Priority issues
6. Opportunities identified
7. User quotes and evidence
...
Be comprehensive and data-driven."""
        ...
        return {
            ...
            "research_synthesis": llm_response,
